...
For training GLIP-T models, we used `nnodes = 2`, `nproc_per_node=16` on 40GB A100 machines. For training GLIP-L models, we used `nnodes = 4`, `nproc_per_node=16` on 40GB A100 machines. Please setup the environment accordingly based on your local machine.
